                    ...
                    <div class="card-body ">
                        <form method="POST" action="/field_officers/{{$user->id}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control " value="{{ $user->name }}" required autocomplete="name" id="name" name="name" type="text">
                                    </div>
                                </div>
                            </div>
                            <!-- /.row-->
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ $user->email }}" required autocomplete="email" id="email" name="email" type="email">
                                    </div>
                                </div>
                            </div>
                            <!-- /.row-->
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ $contact->contact_no }}" required autocomplete="contact_no" id="contact_no" name="contact_no" type="number">
                            ...
                            <div class="row" id='barangay'>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ $user->barangay }}" autocomplete="barangay" id="barangay" name="barangay" type="text">
                                    </div>
                                </div>
                            </div>
                            <!-- /.row-->
                            <div class="row" id='designation' style="display: none;">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ $user->designation }}" autocomplete="designation" id="designation" name="designation" type="text">
                                    </div>
                                </div>
                            </div>
                            <!-- /.row-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ $user->password }}" required autocomplete="password" id="password" name="password" type="text">
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-5 center">
                                ...
                                <div class="col-4 ">
                                    <button class="btn btn-primary px-4 " type="cancel">{{ __('Cancel') }}</button>
                                </div>
                            </div>
                        </form>
