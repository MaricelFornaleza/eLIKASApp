                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="c-callout c-callout-third my-0 py-2">
                            ...
                            <div class="text-value-lg ">
                                <h1 class="p-0 m-0"><strong>{{$admin_inventory->total_number_of_food_packs}}</strong>
                                </h1>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="c-callout c-callout-fourth my-0 py-2">
                            ...
                            <div class="text-value-lg ">
                                <h1 class="p-0 m-0"><strong>{{$admin_inventory->total_number_of_hygiene_kit}}</strong>
                                </h1>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="c-callout c-callout-fourth my-0 py-2">
                            ...
                            <div class="text-value-lg ">
                                <h1 class="p-0 m-0"><strong>{{$admin_inventory->total_number_of_medicine}}</strong>
                                </h1>
                            </div>
                        </div>
                    </div>
