<table id="requestTable" class="table table-borderless table-hover table-light table-striped" style="width: 100%;">
    <thead>
        <tr>
            <th>TIME RECEIVED</th>
            <th>REQUEST ID</th>
            ...
            <tr>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="mb-2 col-6">
                                        <label for="time_received" class="col-form-label small ">Time
                                            received:</label>
                                    ...
                                    <div class="mb-2 col-6">
                                        <label for="id" class="col-form-label small ">Request
                                            ID:</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-2 col-6">
                                        <label for="evacuation_center" class="col-form-label small ">Evacuation
                                            Center:</label>
                            ...
                            <div class="col-md-8  ml-auto mr-auto text-center">
                                <div class="row">
                                    ...
                                    <div class="col-4 border p-2">
                                        <h3 class="pb-0 mb-0"><strong id="food_packs"></strong>
                                        </h3>
                ...
                <td>
                    <div class="row justify-content-between">
                        <div class=" ">
                            <button type="button" class="btn bg-secondary-accent text-white " id="button"
                                data-toggle="modal" data-target="#view" data-array="{{json_encode($delivery_request)}}">
                                View
                            </button>
                        ...
                        <div class="">
                            <a href="{{ route('request.approve', ['id' => $delivery_request->id] ) }}"
                                ...
                                <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg">
                                    <image href="{{ url('icons/sprites/approve-request.svg') }}" height="25"
                                        width="25" />
                                </svg>
                            </a>
                        </div>
                        <div class="mr-2">
                            ...
                            <a href="{{ route('request.admin_decline', ['id' => $delivery_request->id] ) }}"
                                ...
                                <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg">
                                    <image href="{{ url('icons/sprites/decline-request.svg') }}" height="25"
                                        width="25" />
                                </svg>
                            </a>
                        </div>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-4 ">
                            <a href="" data-toggle="modal" data-target="#assignModal"
                                ...
                                /> --}}
                                <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg">
                                    <image href="{{ url('icons/sprites/assign-courier.svg') }}" height="25"
                                        width="25" />
                                </svg>
                            </a>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <form method="POST"
                                                ...
                                                @csrf
                                                <label for="courier_id" class="mr-3 lead modal-title"
                                                    id="exampleModalLabel">Assign
                                                    Courier</label>
                                                <select name="courier_id" id='courier_id' class="w-100 form-control"
                                                    required>
