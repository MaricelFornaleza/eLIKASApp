    ...
    if (value.latitude !== null && value.longitude !== null) {
        var marker = new L.marker([value.latitude, value.longitude], {
            ...
            .bindPopup('<div class="font-weight-bold">' + value.address + ", " + value.name + '</div>' +
                ...
                '</div>' +
                '</div>' +
                '<h6 class="small text-center  my-1">Clothes (' + Math.round((value.clothes / value
                    .capacity *
                    100) * 100) / 100 +
                '%)</h6>' +
                ...
                '</div>' +
                '</div>' +
                '<h6 class="small text-center  my-1">ESA (' + Math.round((value
                ...
                '</div>' +
                '</div>' +
                '<h6 class="small text-center  my-1">Food Packs (' + Math.round((value.food_packs / value
                    .capacity *
                    100) * 100) / 100 +
                '%)</h6>' +
                ...
                '</div>' +
                '</div>' +
                '<h6 class="small text-center  my-1">Hygiene Kit (' + Math.round((value.hygiene_kit / value
                    .capacity *
                    100) * 100) / 100 +
                '%)</h6>' +
                ...
                '</div>' +
                '</div>' +
                '<h6 class="small text-center  my-1">Water (' + Math.round((value.water / value
                    .capacity *
                    100) * 100) / 100 +
                '%)</h6>' +
