                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" placeholder="{{ __('Enter Name') }}" name="name" required autofocus>
                                        @error('name')
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('birthdate') is-invalid @enderror" type="date" placeholder="{{ __('Enter Birthdate') }}" name="birthdate" required autofocus>
                                        @error('birthdate')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="px-3 row justify-content-start">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group row px-3">
                                            <input class="form-check-input @error('gender') is-invalid @enderror" type="radio" name="gender" id="radio_male" value="Male" checked>
